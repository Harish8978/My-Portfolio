const Resume = () => {
    return (
        <section id="resume" className="py-24 bg-[#050505] border-y border-white/5">
            <div className="container px-6 mx-auto space-y-12 text-center">
                ...
                <p className="max-w-2xl mx-auto text-sm font-light leading-relaxed tracking-wide text-white/50 md:text-base">
